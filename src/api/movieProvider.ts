...
import { Movie, MovieDetailsResult, MovieID, MovieListResult } from '../types/movieResultType';
...
const API_KEY = 'dd96e92090dc03ea2a2de0d746eaec4a';
...
export function searchMovies(query: string, page = 1): Promise<MovieListResult> {
